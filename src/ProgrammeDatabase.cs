namespace Beeb {
  ...
  public class ProgrammeDatabase {
    ...
    ProgrammeInformation(string pid) {
      ...
      if (programmeItem != null) return programmeItem;
      ...
      programmeItem = new ProgrammeItem(identifier, System.Int64.Parse(duration));
    ...
    VpidToStreamingUrl(string vpid) {
      ...
      if (streamingUrl != null) return streamingUrl;
      ...
      streamingUrl = "rtmp://" + server + "/ondemand?_fcs_vhost=" + server +
